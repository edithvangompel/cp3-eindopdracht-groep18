...
public class ManScherm extends Screen{
    ...
    override protected function initialize():void{
        ...
        _hemd = _arrButtonsMan2[4];
        _broek = _arrButtonsMan2[5];
        _schoenen = _arrButtonsMan2[6];
    ...
    private function button_triggeredHandlerVrouw(event:starling.events.Event):void{
        ...
        _kleed = _arrButtonsVrouw2[4];
        _hakken = _arrButtonsVrouw2[5];
        trace("[ManScherm] knop Vrouw: " + _knopVrouw);
    ...
    private function button_triggeredHandlerMAN(event:starling.events.Event):void {
        ...
        var hemd:AllButton = _arrButtonsMan2[4];
        var broek:AllButton = _arrButtonsMan2[5];
        var schoenen:AllButton = _arrButtonsMan2[6];
        hemd.alpha = .3;
        broek.alpha = .3;
        schoenen.alpha = .3;
    ...
    private function button_triggeredHandlerVROUW(event:starling.events.Event):void {
        ...
        var kleed:AllButton = _arrButtonsVrouw2[4];
        var hakken:AllButton = _arrButtonsVrouw2[5];
        kleed.alpha = .3;
        hakken.alpha = .3;
