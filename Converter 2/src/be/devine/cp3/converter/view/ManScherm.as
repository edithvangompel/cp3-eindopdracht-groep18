...
public class ManScherm extends Screen{
    ...
    private var _arrButtons:Array = new Array("btn_MAN init","btn_VROUW","lijnen","next_button","duid_aan_tekst","hemd_grijs","broek_grijs","schoenen_man_grijs");
    private var _arrButtons2:Array = new Array();
    private var _arrxPos:Array = new Array(30,150,92,280,90,90,90,90);
    private var _arryPos:Array = new Array(120,120,50,550,0,260,430,550);
